...
public class ColorUtils {
    /* This method returns the appropriate(подходящее) shade of green to form the gradient
     ...
     * was created. */
    public static int getViewHolderBackgroundColorFromInstance(Context context,
                                                               int instanceNum) {
        switch (instanceNum) {
            case 0:
